	...
	glob('./config/env/' + process.env.NODE_ENV + '.js', {
		...
		if (!environmentFiles.length) {
			if (process.env.NODE_ENV) {
                ...
                console.error('\x1b[31m', 'To run your application with a different environment configuration, run the application like this:');
                console.error('\x1b[31m', '$ NODE_ENV={The Environment Name} grunt');
			}
