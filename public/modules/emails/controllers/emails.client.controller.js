...
// Emails controller
angular.module('emails').controller('EmailsController', ['$scope', '$stateParams', '$location', 'Authentication', 'Emails', '$sce',
	function($scope, $stateParams, $location, Authentication, Emails, $sce ) {
        ...
        $scope.htmlOutput = function(data) {
            //$scope.email = data; // Looks like this isn't doing anything.
            return $sce.trustAsHtml(hb.renderContainers(data.containers));
        };
